...
from main.loss import CoordLoss, EdgeLengthLoss, NormalVectorLoss, ParamLoss
from main.module import MeshNet, ParamRegressor, Pose2Feat, PoseNet
from main.resnet import ResNetBackbone
        ...
        if mode == "train":
            ...
            if cfg.stage == "lixel":
                loss["joint_fit"] = self.coord_loss(
                    ...
                    meta_info["fit_joint_trunc"] * meta_info["is_valid_fit"][:, None, None],
                )
                ...
                loss["mesh_fit"] = self.coord_loss(
                    ...
                    meta_info["fit_mesh_trunc"] * meta_info["is_valid_fit"][:, None, None],
                )
